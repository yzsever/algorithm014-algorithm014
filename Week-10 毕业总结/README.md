...
- 第八周：14题 
- 第九周：28题
学习过程中，使用五毒神掌刷题完成4遍共164题，虽然离开营时说的300题还有不小的差距，但是对于自身来说还是不小的成功。大学的时候学习数据结构、学语言编程，研究生学高级算法，各种考试面试还需要面对算法。但是算法对于自己一直很陌生，一直视为一个隐形的敌人，觉得算法很难拿下。幸好参加了算法训练营学到了五毒神掌，让我学习从他人的思路中去学习，原来难题只是我没有找到正确的方法，其实也不过如此。刷题的过程真的是一个持久战的过程，我算是比较懒的，不能坚持每天都刷题，得每周给自己1-2天得休息时间只做做老题不学习新题。因为到第二周开始每天的题量已经上升到10-12题了，每天至少得花4个小时的时间。我第一次感觉刷不动的时候是在第6周DP的时候，觉得很吃力，而且我第五周已经开始提前做DP的题目了，幸好期中周的缓冲时间让我能按时完成DP的题目。第二次到第9周的时候高级DP的时候觉得DP的Hard题还是很费时间，正好遇到国庆周让我能顺利完成所有的刷题。整套算法下来DP和启发式搜索我还需要再啃啃，DP的题目真是刷一遍忘一遍，因为有的Hard的思想还是没能好好的理解，但是每次刷都有更深的理解，只是时间的问题而已。
...
![总结脑图](https://github.com/yzsever/algorithm014-algorithm014/blob/master/Week_10/00-Image/01-算法与数据结构总结脑图.png?raw=true)
